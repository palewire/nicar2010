...
The code here creates interactive maps of unemployment data that are the rough equal of the thematic and proporational symbol maps newspapers have created for years. The data is entirely from the public domain, and the maps are made by employing the OpenLayers library.
